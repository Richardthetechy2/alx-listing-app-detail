...
const Header: React.FC = () => {
    return (
        ...
        ">
                <div>
                    <img src={Icons.alx} alt="alx logo" className="h-6" />
                </div>
            ...
            <div className={`overflow-x-auto flex items-center justify-evenly scrollbar-hide space-x-2 px-7 py-4 text-[12px] text-gray-300 font-medium ${quicksand.className}`}>
                {
                    Logos.map((obj, idx) => {
                        return (
                            <div key={obj.name + idx} className="flex flex-col px-5 w-20 items-center justify-center">
